// wilsonart-tfl-fetch-details.js
// 
//      node wilsonart-tfl-fetch-details.js --offset=26 --limit=1
//   node wilsonart-tfl-fetch-details.js  --offset=22 --limit=1 --batch=1 --headless=true --max-attempts=5
//
// --missing 
//   Scrape only products missing the specified field (default: texture_image_url).
//   Example: node wilsonart-tfl-fetch-details.js --missing texture_image_url
//
// --remaining
//   Scrape only products missing from wilsonart-tfl-laminate-details.json
//   Example: --remaining
//
// --update
//   Update wilsonart-tfl-laminate-details.json in place with any data found in wilsonart-tfl-laminate-details.json but missing from wilsonart-tfl-laminate-details.json
//
// --report
//   Generate a report of all products missing the specified field (default: texture_image_url).
//   Example: --report texture_image_url
//
// List of possible headers or data contained in wilsonart-tfl-laminate-details.json that can be used with --missing or --report:
//    code                 
//    surface-group        
//    name                 
//    product-link         
